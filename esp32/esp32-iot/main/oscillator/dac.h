#ifndef OSCILLATOR_DAC_H
#define OSCILLATOR_DAC_H
...
#define EXAMPLE_ADC_ATTEN ADC_ATTEN_DB_12
    ...
    static const char *TAG_DAC = "dac continuous";
...
#else
        ESP_LOGI(TAG_DAC, "DAC continuous output by timer");
#endif
        ESP_LOGI(TAG_DAC, "DAC channel 0 io: GPIO_NUM_%d", EXAMPLE_DAC_CHAN0_IO);
        ESP_LOGI(TAG_DAC, "DAC channel 1 io: GPIO_NUM_%d", EXAMPLE_DAC_CHAN1_IO);
        ESP_LOGI(TAG_DAC, "Waveform: SINE -> TRIANGLE -> SAWTOOTH -> SQUARE");
        ESP_LOGI(TAG_DAC, "DAC conversion frequency (Hz): %" PRIu32, conv_freq);
        ESP_LOGI(TAG_DAC, "DAC wave frequency (Hz): %" PRIu32, wave_freq);
        ESP_LOGI(TAG_DAC, "--------------------------------------------------");
    }
